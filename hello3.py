...
# curl -X POST localhost:5000/todos -H 'Content-Type: application/json' -d '{"task":"profit more."}'
# curl -v -X PUT localhost:5000/todos/3 -H 'Content-Type: application/json' -d '{"task":"make sure to do lab 7 questions"}'